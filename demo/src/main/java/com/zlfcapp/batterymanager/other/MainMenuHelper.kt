package com.zlfcapp.batterymanager.other

import com.zlfcapp.batterymanager.MainActivity
import com.zlfcapp.batterymanager.banner.BannerActivity
import com.zlfcapp.batterymanager.express.NativeExpressRecyclerViewActivity
import com.zlfcapp.batterymanager.express.NativeExpressSimpleActivity
import com.zlfcapp.batterymanager.fullvideo.FullVideoActivity
import com.zlfcapp.batterymanager.hybrid.SplashHybridActivity
import com.zlfcapp.batterymanager.hybrid.VerticalPreMovieHybridActivity
import com.zlfcapp.batterymanager.inter.InterActivity
import com.zlfcapp.batterymanager.native_.NativeRecyclerViewActivity
import com.zlfcapp.batterymanager.native_.NativeSimpleActivity
import com.zlfcapp.batterymanager.reward.RewardActivity
import com.zlfcapp.batterymanager.reward.RewardProActivity
import com.zlfcapp.batterymanager.splash.SplashHotActivity
import com.zlfcapp.batterymanager.splash.SplashProActivity
...
object MainMenuHelper {
    ...
    private val menuMainList = arrayListOf(
            mapOf(
                    "title" to "广告大全 5.2.1",
                    "desc" to "穿山甲4.2.5.2；优量汇4.441.1311；快手3.3.20；百度5.91"
            ),
            mapOf(
                    "title" to "开屏",
