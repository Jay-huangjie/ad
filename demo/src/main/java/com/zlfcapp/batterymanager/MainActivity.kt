...
import com.zlfcapp.batterymanager.other.MainMenuHelper
...
class MainActivity : ListActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listAdapter = SimpleAdapter(this, menuList,
            R.layout.list_item_main, arrayOf("title", "desc"), intArrayOf(R.id.text1, R.id.text2))
    }
