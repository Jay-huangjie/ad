package com.zlfcapp.batterymanager.reward
...
import com.zlfcapp.batterymanager.core.helper.AdHelperRewardPro
 ...
 */
class RewardProActivity : AppCompatActivity() {
...
//        CsjProvider.Reward.showDownLoadBar = true//不设置默认为true
         ...
         */
        AdHelperRewardPro.show(activity = this, alias = TogetherAdAlias.AD_REWARD, /*ratioMap = ratioMapReward,*/ listener = object : RewardListener {
