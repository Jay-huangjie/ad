...
import com.zlfcapp.batterymanager.core.utils.logd
...
abstract class CsjProviderReward : CsjProviderNativeExpress() {
    ...
    override fun requestRewardAd(activity: FragmentActivity, adProviderType: String, alias: String, listener: RewardListener) {
    ...
    override fun showRewardAd(activity: FragmentActivity): Boolean {
    ...
    override fun requestAndShowRewardAd(activity: FragmentActivity, adProviderType: String, alias: String, listener: RewardListener) {
