...
public class AdSplashManager {
    ...
    private GMNetworkRequestInfo requestInfo;
     ...
     */
    public AdSplashManager(Activity activity, GMNetworkRequestInfo requestInfo,
...
//                String s = App.mContext.getResources().getString(R.string.show_info,
