...
object DispatchUtil {
    ...
    fun getAdProvider(@NotNull alias: String, @NotNull ratioMap: LinkedHashMap<String, Int>): String? {
        return when (com.ifmvo.togetherad.core.TogetherAd.mDispatchTypeMap[alias] ?: com.ifmvo.togetherad.core.TogetherAd.dispatchType) {
            com.ifmvo.togetherad.core.DispatchType.Priority -> {
