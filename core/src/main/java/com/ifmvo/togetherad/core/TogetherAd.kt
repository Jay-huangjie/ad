...
object TogetherAd {
     ...
     * 保存每个广告位的分发方式
     */
    var mDispatchTypeMap = hashMapOf<String, com.ifmvo.togetherad.core.DispatchType>()
    ...
    fun addProvider(@NotNull adProviderEntity: AdProviderEntity) {
        com.ifmvo.togetherad.core.TogetherAd.mProviders[adProviderEntity.providerType] = adProviderEntity
        "注册广告提供商：${adProviderEntity.providerType}".logi()
    }

    internal fun getProvider(providerType: String): AdProviderEntity? {
        return com.ifmvo.togetherad.core.TogetherAd.mProviders[providerType]
    }
     ...
     * map.put(AdProviderType.HUAWEI, 2)
     */
    fun setPublicProviderRatio(@NotNull ratioMap: LinkedHashMap<String, Int>) {
        ...
        com.ifmvo.togetherad.core.TogetherAd.mRatioPublicMap.clear()
        com.ifmvo.togetherad.core.TogetherAd.mRatioPublicMap.putAll(ratioMap)
    }
    ...
    fun getPublicProviderRatio(): LinkedHashMap<String, Int> {
        return if (com.ifmvo.togetherad.core.TogetherAd.mRatioPublicMap.isNotEmpty()) {
            com.ifmvo.togetherad.core.TogetherAd.mRatioPublicMap
        } else {
            val defaultMap = linkedMapOf<String, Int>()
            com.ifmvo.togetherad.core.TogetherAd.mProviders.entries.forEach {
    ...
    fun setCustomImageLoader(@NotNull imageLoader: AdImageLoader) {
        com.ifmvo.togetherad.core.TogetherAd.mImageLoader = imageLoader
    }
     ...
     */
    var dispatchType: com.ifmvo.togetherad.core.DispatchType =
        com.ifmvo.togetherad.core.DispatchType.Random
}