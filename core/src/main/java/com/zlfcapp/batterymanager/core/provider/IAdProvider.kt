package com.zlfcapp.batterymanager.core.provider
...
interface IAdProvider {
    ...
    fun loadAndShowSplashAd(
        @NotNull activity: FragmentActivity,//由于百度必须使用 Activity，所以这里统一传
    ...
    fun loadOnlySplashAd(
        @NotNull activity: FragmentActivity,//由于百度必须使用 FragmentActivity，所以这里统一传
        @NotNull adProviderType: String,
        @NotNull alias: String,//当前广告位的别名
        @NotNull listener: SplashListener//回调
    )
