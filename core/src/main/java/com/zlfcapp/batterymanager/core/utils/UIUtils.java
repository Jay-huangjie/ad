package com.zlfcapp.batterymanager.core.utils;
...
public class UIUtils {
    ...
    public static void hideBottomUIMenu(FragmentActivity activity) {
        if (activity == null) {
            return;
        }
        try {
     ...
     * @return
     */
    public static boolean hasNotchScreen(FragmentActivity activity){
     ...
     * @return
     */
    public static boolean isAndroidPHasNotch(FragmentActivity activity){
     ...
     */
    public static int getInt(String key,FragmentActivity activity) {
        int result = 0;
        if (isMiui()){
            try {
