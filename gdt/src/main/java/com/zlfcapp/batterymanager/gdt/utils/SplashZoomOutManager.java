package com.zlfcapp.batterymanager.gdt.utils;
...
import com.zlfcapp.batterymanager.core.utils.UIUtils;
import com.zlfcapp.batterymanager.core.utils.Utils;
...
public class SplashZoomOutManager {
  ...
  private SplashZoomOutManager() {
    Context context = TogetherAdGdt.INSTANCE.getContext();
    int deviceWidth = Math.min(Utils.getScreenHeight(context),Utils.getScreenWidth(context));
    ...
    zoomOutMargin = Utils.dp2px(6);
    zoomOutAbove = Utils.dp2px(100);
    zoomOutPos = RIGHT;
